    ...
    >
      <View className='flex-1 pt-2 relative'>
        <Image
          source={Image1}
          resizeMode="cover"
          className="mx-12 absolute top-0 z-10 w-52 h-48"
        />
        <View className='mx-9 mt-40 bg-[#2061C7]  flex justify-center border border-red-800 h-32  rounded-[50px] items-center'>
      ...
      <View className='pt-2 relative h-full'>
        <Image
          source={Image3}
          resizeMode="cover"
          className="mx-20 absolute top-0 z-10 w-52 h-52"
        />
        <View className='mx-9 mt-40 bg-[#2061C7] flex justify-center border border-red-800 h-36 rounded-[50px] items-center'>
          <Text className='text-[13px] text-center pt-5 text-white px-2'>Determining trustworthiness and safety of remote {'\n'} consulting in primary healthcare for chronic disease {'\n'} populations in Africa</Text>
        </View>
        <TouchableOpacity onPress={()=> navigation.navigate('SignInScreen')} className='mt-52 mr-3  flex items-end justify-center' >
      ...
      <View className='mx-9 flex justify-center items-center'>
        ...
        <Image
          source={Image2}
          resizeMode="cover"
          className="mx-20 mt-3 w-52 h-52"
        />
      <TouchableOpacity onPress={()=> navigation.navigate('SignUpScreen')} >
     <View className='mt-56 h-11 bg-[#2061C7] w-[70%] mx-14 rounded-[50px]'><Text className='text-center text-[13px] text-white py-3'>Start</Text></View>
    </TouchableOpacity>
      </View>
    </Swiper>
  </View>
