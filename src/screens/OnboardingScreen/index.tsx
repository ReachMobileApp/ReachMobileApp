      ...
      >
        ...
        <View className='pt-2 relative h-full w-full'>
          ...
          <Image
            source={Image3}
            resizeMode="cover"
            className="mx-[30%] absolute z-10 w-[47%] h-[27%]"
          />

          <View className='mx-[5%] mt-[40%] bg-[#2061C7] flex justify-center border border-red-800 h-[17%] rounded-[50px] items-center'>
            <Text className='text-[13px] text-center pt-3 text-white px-2'>Determining trustworthiness and safety of remote {'\n'} consulting in primary healthcare for chronic disease {'\n'} populations in Africa</Text>
          </View>
          <TouchableOpacity onPress={() => navigation.navigate('SignInScreen')} className='mt-[80%] mr-3 flex items-end justify-center' >
        ...
        <View className='flex-1 pt-5 w-full h-full'>
          <View className='mx-9 flex justify-center items-center'>
            <Text className='text-base text-center  text-black px-2'>Determining trustworthiness and safety of {'\n'} remote consulting in primary healthcare for {'\n'} chronic disease populations in Africa</Text>
          </View>
          <Image
            source={Image2}
            resizeMode="cover"
          ...
          <TouchableOpacity onPress={() => navigation.navigate('SignUpScreen')} >
            <View className='mt-[70%] h-12 bg-[#2061C7] w-[70%] mx-14 rounded-[50px] flex items-center justify-center'><Text className='text-center text-base text-white'>Start</Text></View>
          </TouchableOpacity>
        </View>
      </Swiper>
    </View>
