...
const quizQuestions = [
    {
        header: "Question 1:",
        question:
            "What patient outcomes can I expect, beyond avoiding COVID-19? (Select the true statements with regards to the patient journey in remote consulting)",
        options: [
            { text: "Communicating at a right time to the patient is more helpful for managing their health" },
            { text: "Remote consulting rarely helps in improving patient journey" },
            { text: "Short Messages (SMS) are not helpful in record keeping" },
            { text: "SMS gives a chance to communicate non-verbally during remote consulting" },
            { text: "Remote consulting ensures access to services 24 hours a day"},
            { text: "Remote consulting improves face to face consultations"}
        ],
    },
...
const correctAnswers = [
    { options: ["true", "false", "false", "true", "true", "false"] }, // Assuming Phone Calls is correct for Question 1
];
...
const QuizScreen = ({ navigation }: QuizScreenProps) => {
    ...
    const handleSubmit = async () => {
        ...
        if (scorePercentage >= 80) {
            setShowQuiz(false)
            await updateModuleStatus("module4", "completed");
        }
    };
