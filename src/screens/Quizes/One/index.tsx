...
const quizQuestions = [
    {
        header: "Question 1:",
        question: "The following represents apps that can be used in remote consulting",
        options: [
            { text: "Phone Calls" },
    ...
    {
        header: "Question 2:",
        question: "Communicating with each other through a mobile device directly with instant feedback refers to:",
        options: [
    ...
    {
        header: "Question 3:",
        question: "Remote consulting requires the use of digital devices that enable communication and include the following:",
        options: [
            { text: "Phones" },
            { text: "Tablets" },
            { text: "Computers" },
    ...
    {
        header: "Question 4:",
        question: "The following are forms of communication for remote consulting:",
        options: [
            { text: "Palpation" },
            { text: "Audio" },
            { text: "Photo-Video" },
    ...
    {
        header: "Question 5:",
        question: "Which of the following issues should be considered when using remote consulting services?",
        options: [
...
const QuizScreen = ({ navigation }: QuizScreenProps) => {
    ...
    const handleSelection = (questionIndex: number, optionIndex: number, selection: string) => {
        ...
        <ScrollView className="flex-1 bg-white pt-2">
            ...
            <View className="bg-[#064d7d]">
                <View className="flex-row justify-between items-center pt-2 mb-2 px-3">
                    ...
                    {/* Notification icon */}
                    <TouchableOpacity onPress={() => { /* Add navigation logic for notifications */ }} className="p-2">
                                            ...
                                            <View className="flex flex-row gap-4">
                                                <TouchableOpacity
                                                    ...
                                                    style={{
                                                        ...
                                                        borderWidth: 1,
                                                        borderColor: "black",
                                                        backgroundColor: selectedAnswers[index].options[optionIndex] === "true" ? "#064d7d" : "transparent",
                                                    }}
                                                />
                                                <TouchableOpacity
                                                    ...
                                                    style={{
                                                        ...
                                                        borderWidth: 1,
                                                        borderColor: "black",
                                                        backgroundColor: selectedAnswers[index].options[optionIndex] === "false" ? "#064d7d" : "transparent",
                                                    }}
                                                />
                                            </View>
                                        </View>
