...
const QuizScreen = ({ navigation }: QuizScreenProps) => {
  ...
  const [moduleDescription, setModuleDescription] = useState<string | null>(null);
  ...
  return (
    <ScrollView className="flex-1 bg-white pt-2">
      ...
      <View className="p-4">
        <Text className="text-2xl text-[#064d7d] font-bold">{moduleName}</Text>
              ...
              <View className="border p-3 mt-2 border-[#707070]">
                ...
                {questionObj.answers.map((option) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.radioOption,
                      selectedAnswers[questionObj.id] === option.id && styles.selectedOption,
                    ]}
                  >
